 ...
 */
assetsPath = './questionModel/' + document.getElementById('subject_number').value + '/';
...
var onBeforeunloadHandler = function(e){
  e.returnValue = 'まだアンケートは終了していません．このページから離れないでください．';
}
window.addEventListener('beforeunload', onBeforeunloadHandler, false);

//アンケート送信時の処理
document.forms.questionForm.addEventListener('submit', function(e) {
  var message = "アンケートを送信します．よろしいですか？";
