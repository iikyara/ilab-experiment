 ...
 */
var view1,
width = document.getElementById('viewer-zone').clientWidth,
height = document.getElementById('viewer-zone').clientHeight,
 ...
 */
assetsPath = '../pre-experiment/3dmodel/';
var modelname1 = 'briefing.obj';
var mtlName = 'briefing.mtl';
...
function onResize(){
  //サイズを取得
  var width = document.getElementById('viewer-zone').clientWidth;
  var height = document.getElementById('viewer-zone').clientHeight;
...
/*
document.getElementById('model-viewer1').addEventListener('wheel', function(e) {
  if(isMouseOnView1)
  {
    console.log('prevent');
    e.preventDefault();
...
*/
/*
document.getElementById('viewer-zone').addEventListener('mouseover', function(){
  changeFocus(false);
}, false);
*/
 ...
 * imov1=false : 視点のコントロールをOFFに
 */
function changeFocus(imov1){
